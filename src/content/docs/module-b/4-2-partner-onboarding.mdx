...
Use the downloadable [HLD template](../../engagement/deliverables/hld-template/) and [LLD template](../../engagement/deliverables/lld-template/) as the baseline. The auditor wants to see:
...
- [KT plan template](../../engagement/deliverables/kt-plan-template/)
