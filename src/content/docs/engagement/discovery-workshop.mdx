...
<Aside type="tip" title="Download the workfiles">
  ...
  - [📄 Download discovery-workshop-deck.pptx](/templates/engagement/discovery-workshop-deck.pptx)
  - [📄 Download discovery-workshop-workbook.xlsx](/templates/engagement/discovery-workshop-workbook.xlsx)
</Aside>
...
- This documentation site's [Reference Architectures](../reference-architectures/) page
...
5. Within 5 business days, produce an HLD v0.1 using the [HLD template](../deliverables/hld-template/) seeded from the decisions log.
</Steps>
