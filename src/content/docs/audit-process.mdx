...
1. ### Pre-Qualification Confirmation
   ...
   Before requesting the audit, confirm you meet all five [pre-qualification requirements](../requirements/).
...
4. ### Evidence Collection &amp; Submission
   ...
   Use the [Evidence Tracker](../evidence-tracker/) to manage collection across all controls. Below are the control-level pointers.
   ...
   <Tabs>
     <TabItem label="Module A – General">
       ...
       | [1.2 Financial Documentation](../module-a/1-2-financial-documentation/) | Financial statements, professional indemnity insurance |
       | [2.1 Service Delivery Methodology](../module-a/2-1-service-delivery-methodology/) | Delivery methodology, SOW, project artefacts |
       | [2.2 Quality Management](../module-a/2-2-quality-management/) | QMS policy, CSAT process, escalation procedure |
       | [3.1 Customer Satisfaction](../module-a/3-1-customer-satisfaction/) | CSAT/NPS data, references, testimonials |
       | [3.2 Complaint Handling](../module-a/3-2-complaint-handling/) | Complaint register, resolved case, RCA |
       | [3.3 Security &amp; Privacy](../module-a/3-3-security-privacy/) | InfoSec policy, GDPR statement, training records |

     </TabItem>
     <TabItem label="Module B – SAP on Azure">

       | Control | Key Evidence |
       | :--- | :--- |
       | [1.1 SAP on Azure Implementation](../module-b/1-1-sap-on-azure-implementation/) | Case studies, HANA architectures, capability statement |
       | [2.1 ACR Performance](../module-b/2-1-acr-performance/) | Partner Center ACR reports for SAP-eligible services |
       | [2.2 Customer Diversity](../module-b/2-2-customer-diversity/) | Customer list with DPOR/PAL/CSP attribution |
       | [3.1 Skilling](../module-b/3-1-skilling/) | AZ-120 transcripts or Run-SAP-on-MS-Cloud learning-path completions |
       | [4.1 Audit Readiness](../module-b/4-1-audit-readiness/) | Evidence package, index, pre-audit review |
       | [4.2 Partner Onboarding Assets](../module-b/4-2-partner-onboarding/) | SAP migration playbook, HLD/LLD/runbook/KT/hypercare templates |
